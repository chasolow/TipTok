...
# Поля для ввода мощности с использованием text_input или number_input
if power_question == '⚡️ Да':
    P = st.text_input("Введите суммарную мощность объекта (P):", value="0")
    Pdop = st.text_input("Введите дополнительную мощность (Pдоп):", value="0")
else:
    P = st.text_input("Введите суммарную мощность объекта (P):", value="0")
    Pdop = None
...
if schemes == '✅ Есть':
    X = st.number_input("Количество участков ЛЭП от центра питания до каждого электроприемника:", min_value=0, max_value=100, step=1, value=0)
    Y = st.number_input("Количество электроприемников:", min_value=0, max_value=100, step=1, value=0)
else:
    Y = st.number_input("Количество электроприемников:", min_value=0, max_value=100, step=1, value=0)
    X = Y * 1.05
