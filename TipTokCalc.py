...
if power_question == '⚡️ Да':
    P = st.number_input("Введите суммарную мощность объекта (P, кВт):", min_value=0.0, max_value=500000.0, step=0.001, value=0)
    Pdop = st.number_input("Введите дополнительную мощность (Pдоп, кВт):", min_value=0.0, max_value=500000.0, step=0.001, value=0)
else:
    P = st.number_input("Введите суммарную мощность объекта (P, кВт):", min_value=0.0, max_value=500000.0, step=0.001, value=0)
    Pdop = None
...
P = float(P:.0f)
Pdop = float(Pdop:.0f) if Pdop else None
